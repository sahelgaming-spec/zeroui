    ...
    >
      ...
      >
        ...
        >
          ...
          generated by AI, or executed by agents, before it enters your pipeline. Enforce
          policies, ensure traceability, and allow only trusted changes into production.
        </motion.p>
...
const SERVICES = [
  {
    ...
    body: "ZeroUI is a developer-native change governance system that verifies, traces, and enforces policies on every code change across IDEs, CI/CD, and release pipelines.",
  },
  {
    icon: Workflow,
    title: "AI Code Governance",
    body: "Govern and verify AI-generated code before it enters your codebase.",
  },
  {
    icon: Sparkles,
    title: "Agent Execution Control",
    body: "Control and validate actions taken by autonomous agents before they are executed.",
  },
  {
    icon: ShieldCheck,
    title: "Pipeline Enforcement",
    body: "Enforce policies across CI/CD workflows and block unsafe changes before release.",
  },
];
...
const USE_CASES = [
  {
    ...
    body: "ZeroUI verifies and blocks unsafe changes before they are merged.",
  },
  {
    icon: Bot,
    tag: "Autonomous Agents",
    title: "Agents take actions without visibility",
    body: "ZeroUI enforces policy before execution.",
  },
  {
    icon: ShieldCheck,
    tag: "Release & Compliance",
    title: "Risky changes reach production unnoticed",
    body: "ZeroUI enforces compliance and blocks unsafe releases.",
  },
];
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          <Reveal>
            <div>
              ...
              <h2 className="font-display text-4xl leading-tight tracking-tight lg:text-5xl">
                See how ZeroUI fits into your development workflow
              </h2>
